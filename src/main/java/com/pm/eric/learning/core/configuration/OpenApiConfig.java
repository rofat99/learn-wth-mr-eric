package com.pm.eric.learning.core.configuration;
...
public class OpenApiConfig implements WebMvcConfigurer {
    ...
    public OpenAPI baseOpenAPI(){
        ...
        ApiResponse successfulResponse = new ApiResponse().content(
                new Content().addMediaType("application/json", new io.swagger.v3.oas.models.media.MediaType()));
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("Event Management Project's API Docs")
                        .version("1.0.0")
                        .description("This is API document for all end-point using in our project")
                        .contact(new Contact().name("Mason Sales").email("mason.sales@pathmazing.com")));
    }
}
